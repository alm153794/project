...
<%
    ...
    if (recordId == null) {
        response.sendRedirect("view-marriage.jsp");
        return;
    }
%>
<!DOCTYPE html>
...
<head>
    <meta charset="UTF-8">
    <title>Marriage Record Details - East Gojjam VIMS</title>
...
<body>
    ...
    <div class="main-content">
        <div class="user-management-header">
            ...
            <p>Complete marriage registration information</p>
        </div>
        ...
        <div class="form-section">
            <%
                try {
                    ...
                    String sql = "SELECT m.*, u.full_name as registered_by_name " +
            ...
            <div class="user-details-card">
                <div class="detail-header">
                    <div>
                        ...
                        <span class="role-badge role-admin">Marriage Record</span>
                    </div>
                    <% if (rs.getString("photo_path") != null && !rs.getString("photo_path").isEmpty()) { %>
                    <div class="record-photo">
                        <img src="<%= rs.getString("photo_path") %>" alt="Couple Photo" style="width: 180px; height: 120px; object-fit: cover; border-radius: 10px; border: 3px solid #28a745; box-shadow: 0 5px 15px rgba(0,0,0,0.2);">
                    </div>
                    <% } %>
                </div>
                ...
                <div class="detail-grid">
                    ...
                    <div class="detail-item">
                        ...
                        <span><%= rs.getString("groom_first_name") + " " + 
                    ...
                    <div class="detail-item">
                        ...
                        <span><%= rs.getString("bride_first_name") + " " + 
                    ...
                    <div class="detail-item">
                        ...
                        <span><%= rs.getString("marriage_place") %></span>
                    </div>
            ...
            <div class="form-actions">
                ...
                <a href="edit-marriage.jsp?id=<%= recordId %>" class="btn btn-primary"> Edit Record</a>
                <% } %>
                <a href="view-marriage.jsp" class="btn btn-secondary"> Back to Records</a>
            </div>
            
            <%
                    } else {
                        out.println("<div class='error-message'>Marriage record not found!</div>");
                    }
                    rs.close();
                    stmt.close();
                    conn.close();
